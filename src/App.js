...
import { SchoolStore } from './pages/dashboardPages/schoolStore';
...
import { StoreAccountPage } from './pages/backendPages/storeAccountPage';
import { StoreAccontPayments } from './pages/backendPages/StoreAccountPayments';
          ...
          <Routes>
            ...
            <Route element={<PrivateRoute />}>
              ...
              <Route element={<PrivateRoute requiredRole="ADMIN" />}>
                ...
                <Route path='/admin/storeAccountPage' element={<StoreAccountPage />} />
                <Route path='/admin/storeAccountPayments' element={<StoreAccontPayments />} />
                <Route path='/admin/storeAccountApproved' element={<StoreAccontApproved />} />
                <Route path='/admin/storeAccountDeclined' element={<StoreAccontDeclined />} />
                <Route path='/admin/storeAccountPending' element={<StoreAccontPending />} />
