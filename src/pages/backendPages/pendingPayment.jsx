...
export const PendingPayment = () => {
  ...
  const filterAllPayment = async() => {
    ...
    if (studentID.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/pending/?search=${studentID}`;
    } else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/pending/?search=${date}`;
    }else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/pending/?search=${amount}`;
    }else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/pending/?search=${reason}`;
    }
    else {
      getPendingPayment();
      return;
