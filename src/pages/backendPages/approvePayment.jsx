...
export const ApprovePayemnt = () => {
  ...
  const filterAllPayment = async() => {
    ...
    if (studentID.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/approved/?search=${studentID}`;
    } else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/approved/?search=${date}`;
    }else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/approved/?search=${amount}`;
    }else if (date.length !== 0) {
      url = `https://bdmos.onrender.com/api/transactions/approved/?search=${reason}`;
    }
    else {
      getApprovedPayment();
      return;
          ...
          <div className="container-lg">
            <div className="row my-3 pb-4">
              <div className="col-md-8 col-sm-6 col-6">
                <h5>Approved Payment</h5>
                <p>View All Approved Payment</p>
              </div>
