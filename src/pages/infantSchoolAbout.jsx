...
import { faAngleRight, faArrowRight, faBars, faBurger } from "@fortawesome/free-solid-svg-icons";
import { Footer } from "../component/footer";
import pic1 from "../img/screche2.JPG"

export const InfantSchoolAbout = () =>{
	...
	return(
		<div>
			<Navbar />
      <section id="infant-school-about">
        <section id="heading" className="light-background2 mt-5 mb-5">
          <div className="container-lg">
            <div className="d-md-flex d-inline justify-content-between">
              <div>
                <h1 className="ml-text fw-bold dark-font">Infant <span className="text-secondary1">About</span></h1>
              </div>
        ...
        <section className="container-lg mb-5 pb-4">
          <div className="row">
            <div className="col-xxl">
              <div className="row">
                <div className="col-lg-5  d-lg-block mb-5">
                  <div className="row g-4">
                    ...
                    <div className="col-12 col-sm-6 col-lg-12">
                      <div>
                        <div className="d-flex justify-content-between primary-background1 text-white1 p-3">
                          <p className="font-">USEFUL LINKS</p>
                          <FontAwesomeIcon icon={faBurger}/>
                        </div>
                        <div className="infant-school-about-link-container">
                          <div className=" infant-school-about-link-sub-container">
                            <Link to='/about/ourStory' className="infant-school-about-link ">ABOUT US</Link>
                          </div>

                          <div className=" infant-school-about-link-sub-container">
                            <Link to="/gallery" className="infant-school-about-link ">GALLERY</Link>
                          </div>

                          <div className=" infant-school-about-link-sub-container">
                            <Link to="/portal" target="_blank" className="infant-school-about-link ">PORTAL</Link>
                          </div>
                        </div>
                      </div>
                    </div>
